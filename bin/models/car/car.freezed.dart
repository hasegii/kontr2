...
class _$CarImpl implements _Car {
  _$CarImpl({this.id = 0, this.price = '', this.availability = false});
  ...
  @override
  String toString() {
    return 'Car(id: $id, price: $price, availability: $availability)';
  }
...
abstract class _Car implements Car {
  factory _Car({final int id, final String price, final bool availability}) =
      _$CarImpl;
